import { navbarLinks as esNavbarLinks } from "~/data/en/navbarLinks.js";
...
import idealLogo from "../assets/images/ideal_logo.webp";
...
const Navbar = ({ pathname, lang }) => {
  ...
  return (
    <nav className="w-full h-0 absolute top-5 z-50 tracking-wider">
      <div
        className={`${
          navBar || openMobile ? "" : ""
